 ...
 * @param {PnElementFactory} pnElementFactory
 * @param {TextRenderer} textRenderer
 */
export default function LabelBehavior(
    eventBus, modeling, pnElementFactory,
    textRenderer) {
    ...
    this.postExecute(['label.create'], function (event) {
        ...
        if (!is(element.labelTarget || element, 'ptn:PtnElement')) {
            return;
        }
        ...
        if (!di.label) {
            di.label = pnElementFactory.createDiLabel(element);
        }
