...
export default class CustomElementFactory {
	...
	_needsId(element) {
		return isAny(element, ['ptn:ModelElement']);
	}
	...
	createDiLabel() {
		return this.create('ptnDi:DiagramLabel', {
			bounds: this.createDiBounds()
		});
	}

	createDiShape(businessObject, bounds, attrs) {
		return this.create('ptnDi:DiagramShape', assign({
	...
	createDiEdge(businessObject, waypoints, attrs) {
		return this.create('ptnDi:DiagramEdge', assign({
			modelElement: businessObject,
		}, attrs));
	}

	createDiPlane(businessObject) {
		return this.create('ptnDi:Plane', {
			modelElement: businessObject
		});
	}
