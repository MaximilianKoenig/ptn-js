...
export default class PnRuleProvider extends RuleProvider {
  ...
  init() {
    ...
    this.addRule('connection.start', function (context) {
      ...
      return is(source, 'ptn:PtnFlowNode') && { type: 'ptn:Arc' };
    });
...
// Add logic to regulate which elements can be connected.
...
function canDrop(shape, target) {
  ...
  // FlowElements (i.e., places, transitions, and arcs) cannot be dropped on other FlowElements
