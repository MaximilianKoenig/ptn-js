...
export default class CustomPaletteProvider {
  ...
  getPaletteEntries(element) {
    ...
    assign(actions, {
      ...
      // CustomModelerTodo: Add custom palette actions here
      'create-place': createAction(
        `${MODELER_PREFIX}:Place`, 'pn-elements', 'pn-icon-place', translate('Create place')
      ),
      'create-transition': createAction(
        `${MODELER_PREFIX}:Transition`, 'pn-elements', 'pn-icon-transition', translate('Create transition')
      )
    });
    return actions;
  }
