...
export default class CustomPaletteProvider {
  ...
  getPaletteEntries(element) {
    ...
    assign(actions, {
      ...
      'create-silent-transition': createAction(
        `${MODELER_PREFIX}:Transition`, 'custom-elements', 'pn-icon-silent-transition', translate('Create silent transition'), { isSilent: true }
      )
    });
    return actions;
  }
