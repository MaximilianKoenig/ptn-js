import {
  getLabel,
  isLabel
} from '../../pnmodeler/modeling/LabelUtil';
 ...
 * @param {Search} search
 */
export default function CommonSearchProvider(elementRegistry, searchPad, canvas, search) {
 ...
 */
CommonSearchProvider.prototype.find = function(pattern) {
